...
//Helper function that returns a random size
...
//Constructor for given color, random size
Marble::Marble(Marble::Color c) : color(c) {
	size = (Marble::Size)random_size();
}

//Constructor for given size, random color
Marble::Marble(Marble::Size s) : size(s) {
	color = (Marble::Color)random_color();
}

//Constructor for given color and size
...
//Operator for determinining equality
